...
def _page(token: str, snapshot: dict[str, Any]) -> str:
    ...
    return f"""<!doctype html><html lang="zh-CN"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>KnowledgeRadar 本地配置与健康台</title><style>
